...
namespace FFmpeg.NET
{
    public sealed class Engine
    {
        ...
        public async Task<MediaFile> GetThumbnailAsync(MediaFile input, MediaFile output, CancellationToken? cancellationToken = null)
            => await GetThumbnailAsync(input, output, null, cancellationToken);

        public async Task<MediaFile> GetThumbnailAsync(MediaFile input, MediaFile output, ConversionOptions options, CancellationToken? cancellationToken = null)
        {
            var parameters = new FFmpegParameters
            {
        ...
        public async Task<MediaFile> ConvertAsync(MediaFile input, MediaFile output, CancellationToken? cancellationToken = null)
            => await ConvertAsync(input, output, null, cancellationToken);
